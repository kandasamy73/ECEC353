 ...
 *
 * Compile as follows: 
 * gcc -o producer_consumer producer_consumer.c -std=c99 -Wall -lpthread -lm
 */
...
consumer (void *args)
{
    ...
    for (i = 0; i < NUM_ITEMS; i++) {
        ...
        sleep (item); /* Simulate processing */
    }
...
void 
add_to_queue (QUEUE *this_queue, int item)
{
...
int 
remove_from_queue (QUEUE *this_queue)
{
